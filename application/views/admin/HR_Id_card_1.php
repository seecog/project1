...
//jquery start
$.post(basePath+'index.php/HR_Id_card_2',
{ 
emp_no : emp_no
...
document.frm.action = basePath+"index.php/HR_Id_card_2";
document.frm.submit();
});
//jquery end
...
<!-- error div start -->
	...
	<div><font color='red' size='3' face='times new roman'>Employee Id-Card	</font></div><br><br>
