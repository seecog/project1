...
<center>    
    <br><font color='red' size='4' face='times new roman'>Appointment Letter</font></center>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Date :- <b>".date('Y,d M',  strtotime(date('y-m-d')))."</b><br><br>

(Mr/Mrs/Miss) <b>". $employee_register_record[0]['emp_name']."</b><br>
<br>
</p>
...
Dear  <b>".$employee_register_record[0]['emp_name']."</b>,<br>
</p>
<p>

We are pleased to inform you that you have been appointed as <b>". $designation[0]['designation_name']."</b> with us, w.e.f.  <b> ".$employee_register_record[0]['emp_join_date']." </b>
on the following terms and conditions, viz:<br>

</p>
<p>
1.	You will be paid Cost to Company ` <b>Rs. <b>". $employee_register_record[0]['emp_salary']."</b></b> per annum.
...
i.	You will be reporting to the  <b>".$employee_register_record[0]['emp_join_date']."</b>.<br><br>
